...
class PixelRing:
    ...
    def spin(self):
        self.write(0, [self.SPIN, 255, 0, 0])
...
#     pixel_ring.set_color(rgb=0xFF0000)
    #Blue
#     pixel_ring.set_color(rgb=0x0000FF)
    #Green
    pixel_ring.set_color(rgb=0x00FF00)
    #Yellow
#     pixel_ring.set_color(rgb=0xFFFF00)
...
#         pixel_ring.set_color(rgb=level)
#         time.sleep(1)
